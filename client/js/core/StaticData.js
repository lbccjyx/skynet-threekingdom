...
BUILDING_DEFINITIONS = {
    ...
    401: { key: 401, name: '房子2X2', imageDir: 'assets/glb_file/house/22/', width: 1.5, height: 1.5, cost_item: 1, cost_num: 10, cost_item2: 2, cost_num2: 10, cost_item3: 3, cost_num3: 10, build_sec: 10, destroy_sec: 10 },
    402: { key: 402, name: '房子3X2', imageDir: 'assets/glb_file/house/32', width: 2, height: 1.5, cost_item: 1, cost_num: 10, cost_item2: 2, cost_num2: 10, cost_item3: 3, cost_num3: 10, build_sec: 10, destroy_sec: 10 },
    403: { key: 403, name: '房子4X4', imageDir: 'assets/glb_file/house/44', width: 2.5, height: 2.0, cost_item: 1, cost_num: 10, cost_item2: 2, cost_num2: 10, cost_item3: 3, cost_num3: 10, build_sec: 10, destroy_sec: 10 },
    404: { key: 404, name: '房子5X4', imageDir: 'assets/glb_file/house/54', width: 2.5, height: 2.5, cost_item: 1, cost_num: 10, cost_item2: 2, cost_num2: 10, cost_item3: 3, cost_num3: 10, build_sec: 10, destroy_sec: 10 }
};
...
RECT_BUILDING_DEFINITIONS = {
    ...
    3: { key: 3, name: '木质城墙', sub_buildings: 201, sub_max_num: 1 },
    4: { key: 3, name: '石头城墙', sub_buildings: 202, sub_max_num: 1 },
    5: { key: 4, name: '房子2X2', sub_buildings: 401, sub_max_num: 18 },
    6: { key: 4, name: '房子3X2', sub_buildings: 402, sub_max_num: 9 },
    7: { key: 5, name: '房子4X4', sub_buildings: 403, sub_max_num: 2 },
    8: { key: 5, name: '房子5X4', sub_buildings: 404, sub_max_num: 2 }
};
